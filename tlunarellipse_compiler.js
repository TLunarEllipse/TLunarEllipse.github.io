...
var ltlcode2;
var ltlcode3;
var ltlTlink = "https://inquisitive-rust-shaker.glitch.me/";
var ltldebug = 0;
...
function run() {
  ltlcode = document.getElementById("code_tlunarellipse").value;
  //date system:
  stats();
...
function spacing() {
  if (!runnermode) {
    ltlcode0 = document.getElementById("code_tlunarellipse").value;
  }
  if (runnermode) {
      ...
      if (ltlrun) {
        ...
        while (ltlisolationtime < ltlisolationmax) {
          if (ltlrun) {
            ...
            ltlisolation = false;
            if (ltlisolationtime == 1 || ltlisolationtime == ltlisolationmax) {
              ltlisolation = true;
            }
